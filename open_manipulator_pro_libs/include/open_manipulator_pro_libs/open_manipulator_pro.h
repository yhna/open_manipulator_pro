...
public:
  ...
  void initOpenManipulator(bool using_actual_robot_state, STRING usb_port = "/dev/ttyUSB0", STRING baud_rate = "1000000", double control_loop_time = 0.010f, bool with_gripper = false);
